...
import { localTabData } from '../common/Helper';
  ...
  return (
    ...
    <div className='max-w-[1140px] mx-auto px-3'>
      ...
      <div>
        {localTabData.map((obj,i)=>{
return(
        <div id={obj.tab} className={`tabcontent max-w-[400px] p-10 shadow-xl rounded-xl border border-solid border-blue-700 mx-auto ${activeTab === obj.tab ? '' : 'hidden'}`}>
